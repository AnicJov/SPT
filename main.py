...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        mixer_drum.setBackgroundColor(palette.base().color())
        mixer_drum.setColor(palette.highlight().color())
        mixer_bass = MixerWidget(labelText="Bass")
        mixer_bass.setBackgroundColor(palette.base().color())
        mixer_bass.setColor(palette.highlight().color())
        mixer_vocal = MixerWidget(labelText="Vocals")
        mixer_vocal.setBackgroundColor(palette.base().color())
        mixer_vocal.setColor(palette.highlight().color())
        mixer_other = MixerWidget(labelText="Other")
        mixer_other.setBackgroundColor(palette.base().color())
        mixer_other.setColor(palette.highlight().color())
        mixer_master = MixerWidget(labelText="Master")
        mixer_master.setBackgroundColor(palette.base().color())
        mixer_master.setColor(palette.highlight().color())

        settings_button = QPushButton(QIcon.fromTheme("document-properties"), "")
        settings_button.setFixedSize(QSize(30, 30))
        ...
        notation_view_button.setFixedSize(QSize(160, 30))
